...
//		
		// 查詢一筆
		MenuVO menuVO3 = dao.findByPrimaryKey("20181231-0001");
...
//		}
//		
//		List<MenuVO> list2 = dao.findByChefNo("CHEF0001");
//		for(MenuVO bmenuVO : list2) {
//			System.out.print(bmenuVO.getMenuNo() + " , ");
//			System.out.print(bmenuVO.getChefNo() + " , ");
//			System.out.print(bmenuVO.getUnitPrice() + " , ");
//			System.out.print(bmenuVO.getMainCourse() + " , ");
//			System.out.println(bmenuVO.getDeliverable());
//			System.out.println("--------------------------------");	
//		}
	}
}
