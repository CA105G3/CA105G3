...
public class MenuListVO implements java.io.Serializable,Comparable<MenuListVO>{
	...
	@Override
	public int compareTo(MenuListVO other) {
		return (int)(this.getMenuDate().getTime()-other.getMenuDate().getTime());
	}
}
