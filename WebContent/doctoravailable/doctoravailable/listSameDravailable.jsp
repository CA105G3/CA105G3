			...
			<tr>
				...
				<td>
					<form method="post"
						...
						<input type="hidden" name="year" value="${app['year']}"> 
						<input type="hidden" name="month" value="${app['month']}">
						<input type="hidden" name="date" value="${app['日期']}">
						<input type="hidden" name="hour" value="${app['時段']}">
