...
<%
  MedicalOrderVO medicalOrderVO = (MedicalOrderVO) request.getAttribute("medicalOrderVO");
%>

<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>病例資料新增 - MedicalOrder.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>病例資料新增 - MedicalOrder.jsp</h3></td><td>
