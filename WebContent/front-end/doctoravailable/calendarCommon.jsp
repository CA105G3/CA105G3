<%@ page import="com.doctoravailable.controller.Month,java.util.*,java.io.*,java.sql.*" errorPage="error.jsp" %>
<%
  ...
  java.util.Date firstDayOfNextMonth = new java.util.Date(intYear, intMonth, 1);
  GregorianCalendar nextMonthCal = new GregorianCalendar();
  nextMonthCal.setTime(firstDayOfNextMonth);
