...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item bread-item" style="background-image: url('<%=request.getContextPath()%>/front-end/impression/img/shgranma.gif');" data-stellar-background-ratio="0.5">
      ...
      <div class="slider-item bread-item" style="background-image: url('<%=request.getContextPath()%>/front-end/impression/img/chicken-attack.png');" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
...
<ul>
  <li><a href="<%= request.getContextPath()%>/front-end/impression/listAllImp.jsp">List</a> all Imps.  <br><br></li>
  
  
  <li>
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/impression/impression.do" >
        <b>輸入心得編號 (如I0001):</b>
...
<ul>
  <li><a href="<%=request.getContextPath()%>/front-end/impression/addImp.jsp">Add</a> a new Imp.</li>
</ul>    
