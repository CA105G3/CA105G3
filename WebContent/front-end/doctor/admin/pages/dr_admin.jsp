...
<%@page import="com.medicalorder.model.MedicalOrderService"%>
...
<% 
	...
	pageContext.setAttribute("dvo", dvo);
%>
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">
                    	<c:if test="${dvo.isonline == '線上'}">
	                    	<span aria-label="目前在線上" style="background: rgb(66, 183, 42); border-radius: 50%; display: inline-block; height: 10px; margin-left: 4px; width: 10px;"></span> 
                    	</c:if>
                    
                    	<c:if test="${dvo.isonline != '線上'}">
                    		<span aria-label="目前離線" style="background: rgb(128, 128, 128); border-radius: 50%; display: inline-block; height: 10px; margin-left: 4px; width: 10px;"></span> 
                    	</c:if>
						<%=dvo.getIsonline()%>
                    </h1>
                </div>
...
<!--                                     <i class="fa fa-comments fa-5x"></i> -->
										 <i class="fas fa-calendar-day fa-10x"></i>
                                </div>
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><%=todayList.size()%></div>
                                    <div>今日預約數</div>
                                </div>
                            </div>
                        </div>
                        <a href="<%=request.getContextPath()%>/front-end/medicalOrder/drTodayAppointment.jsp?drno=${drno}">
...
<!--                                     <i class="fa fa-tasks fa-5x"></i> -->
                                    <i class="fas fa-calendar-week fa-10x"></i>
                                </div>
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><%=thisWeekList.size()%></div>
                                    <div>本週剩餘預約數</div>
                                </div>
                            </div>
                        </div>
                        <a href="<%=request.getContextPath()%>/front-end/medicalOrder/drThisWeekAppointment.jsp">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
...
<!-- 										 <i class="fas fa-dollar-sign fa-5x"></i> -->
                        ...
                        <a href="<%=request.getContextPath()%>/front-end/medicalOrder/drMoThisMonthDone.jsp">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
