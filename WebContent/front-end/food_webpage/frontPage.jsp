...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="container memberchefList">
        <div class="row first">
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/food2.jpg" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者1</font></h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/food3.jpeg" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者2</font></h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/hotpot1.jpg" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者3</font></h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/food4.jpg" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者4</font></h5>
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row second">
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/food10.jpg" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者5</font></h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/food12.png" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者6</font></h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/food13.jpg" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者7</font></h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/food8.jpg" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者8</font></h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container memberchefList">
        <div class="row second">
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/hotpot2.JPG" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者9</font></h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/food10.jpg" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者10</font></h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/spaghetti1.jpg" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者11</font></h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3">
                <a href="#"><img class="card-img" src="images/pizza1.jpeg" alt="Card image cap"></a>
                <div class="card-body">
                    <h5 class="card-title"><font id="font-type">餐飲業者12</font></h5>
                </div>
            </div>
        </div>
    </div>
