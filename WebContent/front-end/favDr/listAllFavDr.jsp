...
<%
    ...
    List<FavDrVO> list = fdSvc.getAll();
...
<html>
<head>
<title>所有追蹤資料 - listAllFavDr.jsp</title>
...
<table>
	...
	<c:forEach var="fdVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
