...
<%
	...
	List<MedicalOrderVO> list = mSvc.getByDrnoThisMonthDone(drno);
...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">歷史看診紀錄</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<form action="getMoByDrno.jsp">
							<input class="btn btn-success" type="submit" value="所有看診紀錄" />
						</form>
					</div>
					<!-- /.panel-heading -->
						...
						<table class="table table-striped table-borderedtable table-hover"
	                    	...
	                    	${memVO.memName}
								...
								<tr>
									<!-- 							<th>問診影音紀錄</th> -->
									<!-- 								<td> -->
									<!-- 									<video style="width: 400px; height: 225px; left: 0px; top: 0px;" controls> -->
									<%-- 									    <source src="<%=request.getContextPath()%>/front-end/medicalOrder/medicalOrderServletImg.do?moNo=${mvo.moNo}" type="video/mp4"> --%>
									<!-- 									</video>  -->
									<!-- 								</td> -->
									<!-- 							</tr> -->
							</c:forEach>
