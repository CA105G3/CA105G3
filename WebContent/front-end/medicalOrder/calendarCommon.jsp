<%@ page import="com.doctoravailable.controller.*,java.util.*,java.io.*,java.sql.*,java.text.*,java.util.Date" errorPage="error.jsp" %>
<%
  ...
  int daysInCurrentMonth = theCal.getActualMaximum(Calendar.DAY_OF_MONTH);
  ...
  String strNowday = str.substring(6, 8);
  String strNowHour = str.substring(8, 10);
  Integer IntNowday = Integer.parseInt(strNowday);
  Integer IntNowHour = Integer.parseInt(strNowHour);
