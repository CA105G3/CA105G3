...
// 	String drno = request.getParameter("drno");
	...
	List<MedicalOrderVO> list = mSvc.getByDrnoThisWeek(drno);
...
<%@ include file="/front-end/doctor/doctorAdminNav.file"%>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">本週剩餘預約</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<table class="table table-striped table-borderedtable table-hover"
						...
						<c:forEach var="mvo" items="${list}" varStatus="s" begin="<%=pageIndex%>"
...
// 				var element = this;
// 				console.log($("[id='moNo' + i]"));
// 				var data = {
// 						action : 'cancle_medicalorder_ByDr',
// 						moNo : $("[id='moNo' + i]").val(),
// 					};
// 				$.ajax({
