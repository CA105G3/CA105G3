	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><%=request.getContextPath()%>/front-end/index.jsp#menuTarget" class="nav-link">活動專區</a></li>
	  ...
	  <div class="container-fluid">
	    <div class="row">
	    	<c:forEach var="menuVO" items="${list}">      
		      <div class="col-xs-12 col-sm-3 col-lg-2" style="margin-left: 10px;margin-right: 10px;">
		        <div class="card" style="width: 190px; margin-top: 10px; margin-bottom: 10px;">
		          <div class="card-image">
		            <img style="max-width: 190px; max-height: 250px;" src="<%=request.getContextPath()%>/front-end/menu/menuImg.do?menuNo=${menuVO.menuNo}" alt="Card image cap">
		          </div>
